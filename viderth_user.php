...
<div class="post-scroll">
			...
			<div class="info-column">
				...
				<a href="mtfalcon.php"><p class="post-scroll-title">Beaver Brook</p></a>
		...
		<div class="post-scroll">
			<div class="video-map-column">			
				<iframe class="video-youtube" src="https://www.youtube.com/embed/N6Dbnko4hU0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
			...
			<div class="info-column">
				<div class="title-user-block">
					...
					<div class="scroll-info-block">
						<div class ="scroll-info">
							<p class="post-length">length: 12.34 miles</p>
