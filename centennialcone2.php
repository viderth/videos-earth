...
<title>Centennial Cone Park</title>
...
<p class ="adventure-description">Centennial Cone Park is a test of endurance.  It has a 12.3 mile loop Bring plenty of water as there this is a very exposed trail.  The loop only has 2 exit points.  There are restrooms at both access points.  Be sure to check if there are closings as this happens annuly in spring time to early summer.
<div class="post-data-chart">
    ...
    <iframe  class="post-video" src="https://www.youtube.com/embed/N6Dbnko4hU0" frameborder="0" 
    ...
    <script>
        ...
        const gpxUrl = 'http://localhost/centennialcone.gpx';
